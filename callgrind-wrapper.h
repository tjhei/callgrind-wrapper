#ifndef _callgrind_wrapper_h_
#define _callgrind_wrapper_h_

/**
 * A simple wrapper around callgrind to query current instruction counter values
 *
 * Usage:
 *
 *  valgrind --tool=callgrind -q --combine-dumps=yes --callgrind-out-file=callgrind.out ./executable
 *
 * (c) Timo Heister github.com/tjhei/
 */
